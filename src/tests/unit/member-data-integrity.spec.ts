...
import type { TSocial, TSong, TMusicLink, Tnationality, Tposition } from '../../types/members';
...
describe('Member Data Integrity', () => {
    ...
    MEMBERS.forEach((member) => {
      describe(`Member: ${member.name}`, () => {
        ...
        it('should have valid nationality', () => {
          const validNationalities: Tnationality[] = ['South Korean', 'Japanese', 'Taiwanese'];
        ...
        it('should have valid positions', () => {
          ...
          const validPositions: Tposition[] = [
            'Main Vocalist', 'Main Dancer', 'Visual', 'Center', 'Group Face',
            'Sub-Vocalist', 'Sub-Rapper', 'Leader', 'Main-Rapper', 'Maknae'
          ];
  ...
  describe('Group consistency', () => {
    it('should have proper nationality distribution', () => {
      const nationalityCount = MEMBERS.reduce((acc, member) => {
