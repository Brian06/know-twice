...
const MEMBER_COLORS: TmemberColors = {
  nayeon: {
    bg: "bg-nayeon",
    outline: "outline-nayeon",
    hover: "hover:bg-nayeon",
  },
  jeongyeon: {
    bg: "bg-jeongyeon",
    outline: "outline-jeongyeon",
    hover: "hover:bg-jeongyeon",
  },
  ...
  dahyun: {
    bg: "bg-dahyun",
    outline: "outline-dahyun",
    hover: "hover:bg-dahyun",
  },
  chaeyoung: {
    bg: "bg-chaeyoung",
    outline: "outline-chaeyoung",
    hover: "hover:bg-chaeyoung",
  },
  tzuyu: { bg: "bg-tzuyu", outline: "outline-tzuyu", hover: "hover:bg-tzuyu" },
};

export const getMemberColors = (
  memberId: TmemberId,
): TmemberColors[TmemberId] => {
  ...
  if (!colors) {
    return {
      ...
      outline: "",
      hover: "",
    } as unknown as TmemberColors[TmemberId];
  }
  return colors;
};
...
export const generateMemberClass = (
  memberId: TmemberId,
  type: "bg" | "outline" | "hover",
) => {
  ...
  return (
    getMemberColors(memberId)[type] || ("" as Tbackground | Toutline | Thover)
  );
};
